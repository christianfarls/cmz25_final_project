...
| `ENTRY_OPEN`    | Always (option to add delay)                             | `ENTRY_CLOSE`       | Open entry gate for one cycle.               |
| `ENTRY_CLOSE`   | Always (option to add delay)                              | `IDLE`              | Close entry gate and return to idle.         |
